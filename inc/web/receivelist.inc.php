...
$pagesize=10;
$sql="select a.* ,b.name,b.img as  user_img from " . tablename("zh_jdgjb_jfrecord") . " a"  . " left join " . tablename("cjdc_user") . " b on b.id=a.user_id WHERE a.good_id =".$_GPC['good_id']." order by id DESC";
$select_sql =$sql." LIMIT " .($pageindex - 1) * $pagesize.",".$pagesize;
$list = pdo_fetchall($select_sql);	   
$total=pdo_fetchcolumn("select count(*) from " . tablename("zh_jdgjb_jfrecord") . " a"  . " left join " . tablename("cjdc_user") . " b on b.id=a.user_id WHERE a.good_id =".$_GPC['good_id']."");
