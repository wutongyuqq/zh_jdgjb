...
$sql="select a.* ,b.img,b.commission from " . tablename("zh_jdgjb_distribution") . " a"  . " left join " . tablename("cjdc_user") . " b on b.id=a.user_id  ". $where." ORDER BY id DESC";
...
if($_GPC['id2']){
  $id=$_GPC['id2'];
  //pdo_update('cjdc_user',array('commission +='=>$_GPC['reply']),array('id'=>$id));
